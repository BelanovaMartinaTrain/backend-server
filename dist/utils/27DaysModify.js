...
const fetch27DayForecastAndModify = (params) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!lastRequestTimestamp) {
        ...
        try {
            ...
            const replySetRedisData = yield server_1.redisClient.json.set(apiRedisKey, "$", newLines);
...
exports.default = fetch27DayForecastAndModify;
